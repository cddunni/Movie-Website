...
import DocumentationIcon from './icons/IconHome.vue'
import ToolingIcon from './icons/IconFriends.vue'
import EcosystemIcon from './icons/IconCompass.vue'
import CommunityIcon from './icons/IconCommunity.vue'
import SupportIcon from './icons/IconTimer.vue'
</script>
